...
public class SplashScreen extends AppCompatActivity {
    ...
    private final Runnable mHidePart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            logo_image.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
...
//        });
    ...
    private void show() {
        // Show the system bar
        logo_image.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mVisible = true;
    ...
    private void animation1() {
        ...
        logo_image.startAnimation(pulse);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ObjectAnimator scaleXAnimation = ObjectAnimator.ofFloat(logo_image, "scaleX", 1.0F, 0.1F);
                scaleXAnimation.setInterpolator(new AccelerateDecelerateInterpolator());
                scaleXAnimation.setDuration(1200);
                ObjectAnimator scaleYAnimation = ObjectAnimator.ofFloat(logo_image, "scaleY", 1.0F, 0.1F);
    ...
    private void startIntent(){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                boolean isFirstStart = true;//getPrefs.getBoolean("firstStart", true);

                Log.d("DEBUG","LAUNC APP INTRO >>>> isFirstStart >> "+isFirstStart);
                //  If the activity has never started before...
                if (isFirstStart) {
                    Log.d("DEBUG", "LAUNC APP INTRO");
                    //  Launch app intro
